...
const connectingstring = "mongodb+srv://checkingdatabasewithgolang:arka@cluster0.y5kdalv.mongodb.net/?retryWrites=true&w=majority"
...
func init() {
	...
	// if the collection instance is ready
	fmt.Println("Collection instance is ready for me")
}
